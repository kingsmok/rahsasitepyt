...
│ (Postgres│ │(کش/صف/ │   │ زرین‌پال، │   │  ترب/ایمالز │  │  اسنپ/تپسی  │
│  در prod)│ │RateLimit│   │ اسنپ‌پی، │   │ دیجی‌کالا، │  │  Map.ir    │
│         │ │        │   │ دیجی‌پی  │   │  باسلام    │  │            │
└────────┘ └─────────┘   └──────────┘   └────────────┘  └─────────────┘
```
...
| Map.ir | ✅ صفحه آدرس + برآورد | ثبت `mapir_api_key` |
| اسنپ/تپسی پیک | ✅ برآورد هزینه | API واقعی قیمت‌گذاری |
...
- برآورد ارسال: اصفهان ۴۴۰km → اسنپ/تپسی ✅
- Cashback: خرید sandbox ۱٬۰۳۲٬۰۰۰ → ۲۰٬۶۴۰ (۲٪) به کیف پول + لاگ ✅
- PriceHistory: ۱۲۰ نقطه seed + ثبت خودکار هنگام خرید ✅
