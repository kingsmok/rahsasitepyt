...
PERSIAN_THEMES = [
    ...
    dict(id='pd-01', key='isfahan_turquoise', name='فیروزه‌ای اصفهان',
         ...
         hero=[dict(img='hero.webp', title='آکادمی دانش — پنجره‌ای به دانایی بی‌پایان',
                    sub='همراه با استادان دانشگاهی و گواهینامه‌های معتبر؛ از دانشکده تا بازار کار.',
         ...
         features=[('🕌', 'آموزش اصیل', 'بر پایه سرفصل‌های دانشگاهی و منابع معتبر'),
                   ('🏛', 'گواهینامه معتبر', 'مدرک پایان دوره با تأییدیه رسمی'),
                   ('👳‍♂️', 'اساتید برجسته', 'هیئت علمی و مدرسان باتجربه'),
                   ('📜', 'کتابخانه غنی', 'جزوه‌ها و منابع مکتوب کلاسیک'),
                   ('⚖️', 'اخلاق حرفه‌ای', 'تعهد، انضباط و احترام در یادگیری'),
                   ('🕰', 'دسترسی مادام‌العمر', 'همیشه و همه‌جا در دسترس شما')],
         course_title='📚 دوره‌های دانشکده', course_sub='منتخب استادان دانشگاه',
         cta=dict(title='به جمع دانشجویان آکادمی بپیوندید', text='دریافت مشاوره تحصیلی رایگان',
                  btn_text='مشاوره رایگان', btn_url='/consultation')),
    # ── ۲ ────────────────────────────────────────────────
    dict(id='pd-02', key='saffron_qainat', name='زعفرانی قائنات',
         ...
         cta=dict(title='وقت طلاست — همین امروز شروع کن!', text='ثبت‌نام با تخفیف ویژه زعفرانی',
                  btn_text='ثبت‌نام و دریافت تخفیف', btn_url='/register')),
    # ── ۳ ────────────────────────────────────────────────
    dict(id='pd-03', key='shiraz_lapis', name='لاجوردی شیراز',
         ...
         cta=dict(title='ذهنت را آزاد کن', text='جلسه اول همه دوره‌ها رایگان است',
                  btn_text='رایگان شروع کنید', btn_url='/courses')),
    # ── ۴ ────────────────────────────────────────────────
    dict(id='pd-04', key='yazd_pomegranate', name='اناری یزد',
         ...
         cta=dict(title='اثر هنری بعدی، اثر توست', text='با ۲۰٪ تخفیف جشنواره هنر',
                  btn_text='شرکت در جشنواره', btn_url='/register')),
    # ── ۵ ────────────────────────────────────────────────
    dict(id='pd-05', key='kavir_terracotta', name='سفال کویر',
         ...
         cta=dict(title='استادکار شو', text='مشاوره رایگان انتخاب مسیر شغلی',
    ...
    dict(id='pd-06', key='termeh_yazdi', name='ترمه یزدی',
         ...
         cta=dict(title='مدیر فردا، امروز ساخته می‌شود', text='رزرو جلسه معرفی رایگان',
    ...
    dict(id='pd-08', key='rosewater_qamsar', name='گلاب قمصر',
         ...
         cta=dict(title='زندگی زیباتر می‌شود', text='اولین دوره را رایگان امتحان کن',
                  btn_text='شروع رایگان', btn_url='/courses')),
    # ── ۹ ────────────────────────────────────────────────
    dict(id='pd-09', key='pistachio_rafsanjan', name='پسته رفسنجان',
         ...
         cta=dict(title='ریشه‌هایت را عمیق کن', text='تخفیف ویژه فصل برداشت',
                  btn_text='شروع رشد', btn_url='/register')),
    # ── ۱۰ ───────────────────────────────────────────────
    ...
    dict(id='pd-11', key='traditional_tile', name='کاشی سنتی',
         ...
         cta=dict(title='هفت‌رنگ یاد بگیر', text='جشنواره هنر ایرانی با ۲۵٪ تخفیف',
                  btn_text='مشاهده جشنواره', btn_url='/courses')),
    # ── ۱۲ ───────────────────────────────────────────────
    dict(id='pd-12', key='orosi_stained_glass', name='شیشه رنگی ارسی',
         ...
         cta=dict(title='کودک خلاقت را خوشحال کن', text='جلسه اول رایگان برای کودکان',
    ...
    dict(id='pd-13', key='wood_mat', name='چوب و حصیر',
         ...
         cta=dict(title='با دست‌هایت بساز', text='کارگاه رایگان شنبه‌ها',
    ...
    dict(id='pd-14', key='iranian_miniature', name='مینیاتور ایرانی',
         ...
         cta=dict(title='نگاره بعدی را تو بکش', text='کارگاه رایگان مینیاتور',
    ...
    dict(id='pd-16', key='mountain_snow', name='سهند و سبلان',
         ...
         cta=dict(title='ساده و مؤثر بیاموز', text='رایگان شروع کن',
                  btn_text='شروع رایگان', btn_url='/courses')),
    # ── ۱۷ ───────────────────────────────────────────────
    ...
    dict(id='pd-18', key='khorasan_agate', name='عقیق خراسانی',
         ...
         cta=dict(title='گوهر دانش را صیقل بده', text='جشنواره ادبی با ۲۰٪ تخفیف',
    ...
    dict(id='pd-20', key='tehran_modern', name='مدرن تهران',
         ...
         cta=dict(title='به آینده بپیوند', text='تجربه ۱۴ روزه رایگان',
                  btn_text='شروع آزمایشی', btn_url='/register')),
]
...
def component_html(t):
  ...
  <div style="max-width:380px;margin:0 auto;background:#fff;border-radius:20px;overflow:hidden;border:1px solid {p}22;box-shadow:0 14px 34px {tx}12">
    ...
    <div style="padding:20px">
      ...
      <h3 style="font-size:17px;font-weight:900;margin:12px 0 8px;color:{tx}">عنوان دوره نمونه — {t['name']}</h3>
  ...
  <div style="max-width:1000px;margin:0 auto">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:16px">
      ...
      <div style="background:#fff;border-radius:18px;padding:20px;border-top:4px solid {p}"><b style="color:{p}">🏆 افتخارات</b><p style="font-size:12.5px;color:{tx}88;margin-top:8px">بیش از ۵۰ هزار دانشجو و ۶ سال حضور مستمر.</p></div>
    </div>
  </div>''', 'about_us'),
